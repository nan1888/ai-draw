export type AiCanvasRole = 'image_holder' | 'ai_image' | 'reference_image' | 'annotation_text' | 'annotation_arrow' | 'annotation_mark' | 'version_group';
...
export type ImageProviderEventStage = 'submit' | 'submitted' | 'poll' | 'completed' | 'failed' | 'download' | 'saved';
...
export interface ImageProviderSettingsStatus extends Omit<ImageProviderSettings, 'apiKey'> {
    hasApiKey: boolean;
}
...
export type RunType = 'generate' | 'edit_from_annotations' | 'compose_reference_images' | 'run_workflow' | 'upload_reference_images' | 'insert_image_into_holder' | 'create_image_version' | 'failed';
...
export type CanvasPendingOperationType = 'create_image_holder' | 'insert_image_into_holder' | 'create_image_version' | 'insert_composite_image' | 'insert_reference_image';
